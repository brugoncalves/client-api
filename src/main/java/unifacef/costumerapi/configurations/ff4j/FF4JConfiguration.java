package unifacef.costumerapi.configurations.ff4j;
...
public class FF4JConfiguration extends SpringBootServletInitializer {
    ...
    public ServletRegistrationBean ff4jDispatcherServletRegistrationBean(final FF4jDispatcherServlet ff4jDispatcherServlet) {
